    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('amount', models.IntegerField(default=1, validators=[django.core.validators.MaxValueValidator(36), django.core.validators.MinValueValidator(1)])),
                ...
                ('mentor', models.ForeignKey(default='Ментор пока не определен', on_delete=django.db.models.deletion.SET_DEFAULT, related_name='groups', to='staff.staff')),
